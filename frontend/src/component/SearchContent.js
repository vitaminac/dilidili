...
import { VIDEO_ROUTE_PREFIX, BANGUMI_ROUTE_PREFIX, API_BASE_URL } from '../Config';
...
class VideoItem extends React.Component {
    ...
    render() {
        ...
        var linkUrl = VIDEO_ROUTE_PREFIX + this.props.data.param;
...
class BangumiItem extends React.Component {
    ...
    render() {
        return <div className="special-li floatleft">
            ...
            <div className="info floatleft">
                <a href={BANGUMI_ROUTE_PREFIX + this.props.data.param} target="_blank" className="title">{this.props.data.title}</a>
